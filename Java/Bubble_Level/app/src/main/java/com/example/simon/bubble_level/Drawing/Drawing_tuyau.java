...
/**
 * Created by Guillaume Touzin on 2016-08-29.
 */
public class Drawing_tuyau extends View{
   ...
   // private float t;
    ...
    public Drawing_tuyau(Context context, AttributeSet attrs)
    {
        super(context, attrs);
...
/*
        ...
        //Affichage du texte
        canvas.drawText(circleText, viewWidthHalf, this.getMeasuredHeight()-30, labelPaint);
*/
