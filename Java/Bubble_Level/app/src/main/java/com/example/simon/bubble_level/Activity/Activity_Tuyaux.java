...
import com.example.simon.bubble_level.Drawing.Drawing_tuyau;
import com.example.simon.bubble_level.R;

public class Activity_Tuyaux extends AppCompatActivity implements FragmentDrawer.FragmentDrawerListener{

    private Toolbar mToolbar;
    private FragmentDrawer drawerFragment;
    Drawing_tuyau myDraw;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activity_tuyaux);

        myDraw = (Drawing_tuyau) findViewById(R.id.custViewTuyau);
        ...
        drawerFragment.setUp(R.id.fragment_nav_drawer, (DrawerLayout) findViewById(R.id.drawer_layout_tuyaux), mToolbar);
