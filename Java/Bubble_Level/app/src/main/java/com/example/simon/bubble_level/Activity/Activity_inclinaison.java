...
public class Activity_inclinaison extends AppCompatActivity implements FragmentDrawer.FragmentDrawerListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inclinaison);
        ...
        drawerFragment.setUp(R.id.fragment_nav_drawer, (DrawerLayout) findViewById(R.id.drawer_layout_incl), mToolbar);
